...
class ReplicaXLite(QMainWindow):
    ...
    def create_connections(self):
        ...
        self.menu_actions['rotate_x_pos'].triggered.connect(lambda: self.manage_interactor.rotate_view_global(axis='x', angle=self.settings['interactor']['rotation_angle_deg_x']))
        self.menu_actions['rotate_x_neg'].triggered.connect(lambda: self.manage_interactor.rotate_view_global(axis='x', angle=-self.settings['interactor']['rotation_angle_deg_x']))
        self.menu_actions['rotate_y_pos'].triggered.connect(lambda: self.manage_interactor.rotate_view_global(axis='y', angle=self.settings['interactor']['rotation_angle_deg_y']))
        self.menu_actions['rotate_y_neg'].triggered.connect(lambda: self.manage_interactor.rotate_view_global(axis='y', angle=-self.settings['interactor']['rotation_angle_deg_y']))
        self.menu_actions['rotate_z_pos'].triggered.connect(lambda: self.manage_interactor.rotate_view_global(axis='z', angle=self.settings['interactor']['rotation_angle_deg_z']))
        self.menu_actions['rotate_z_neg'].triggered.connect(lambda: self.manage_interactor.rotate_view_global(axis='z', angle=-self.settings['interactor']['rotation_angle_deg_z']))

        self.menu_actions['move_x_positive'].triggered.connect(lambda: self.manage_interactor.move_camera_global('x', -self.settings['interactor']['distance_step_x']))
        self.menu_actions['move_x_negative'].triggered.connect(lambda: self.manage_interactor.move_camera_global('x', self.settings['interactor']['distance_step_x']))
        self.menu_actions['move_y_positive'].triggered.connect(lambda: self.manage_interactor.move_camera_global('y', -self.settings['interactor']['distance_step_y']))
        self.menu_actions['move_y_negative'].triggered.connect(lambda: self.manage_interactor.move_camera_global('y', self.settings['interactor']['distance_step_y']))
        self.menu_actions['move_z_positive'].triggered.connect(lambda: self.manage_interactor.move_camera_global('z', -self.settings['interactor']['distance_step_z']))
        self.menu_actions['move_z_negative'].triggered.connect(lambda: self.manage_interactor.move_camera_global('z', self.settings['interactor']['distance_step_z']))
        ...
        self.menu_actions['screenshot'].triggered.connect(lambda: self.manage_interactor.take_screenshot(None, self.settings['interactor']['transparent_background'], self.settings['interactor']['scale']))
